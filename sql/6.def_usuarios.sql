...
('mfloresh@pcm.gob.pe', 'scrypt:32768:8:1$RhEjqzN2dHk7Zn4e$ee7402882ca399c5a24b818cab9c86d427a5e20d59b844f88457838597f79266c9ed253568e25c999653efa6c101c9fff4e0f70f8d02940be1cd5800de1f6ad4', True, False, True, True, False, False, null, 4, 3, 45, 1, '01-08-2025'),
('lrodriguez@pcm.gob.pe', 'scrypt:32768:8:1$R2VwxaFFqhLMZ2GZ$a87e56342ff475edd0d064fd6545100bcf88bbe062ae04a4be937db5cb236b3dba9d12c75e1e5a489e3bb9dd26cd5e37e85109f588792f4776e6d7ee61ecb21a', True, True, True, True, True, True, null, 4, 5, 45, 1, '21-11-2025');

UPDATE ide.def_usuarios
SET id_perfil = 4
WHERE id IN (3,4);

UPDATE ide.def_instituciones SET sigla = 'AGN'
WHERE id = 63;

--Nivel 1: Lectura , 2: Escritura

TRUNCATE TABLE ide.aso_usuarios_roles RESTART IDENTITY CASCADE;
