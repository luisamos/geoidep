...
(null, 'Herramientas digitales', 'Son un conjunto de herramientas GIS que pertite compartir diferentes datos geográficos.', True, 0, 1, 1, '01-08-2025', null),
(null, 'Servicios OGC', 'Los servicios del Open Geospatial Consortium son estándares internacionales que permiten a diferentes sistemas compartir y acceder a datos e información geográfica a través de la web de forma abierta e interoperable.', True, 0, 2,  1, '01-08-2025', null),
(null, 'Servicios Rest de ArcGIS', 'Los Servicios REST de ArcGIS son una tecnología que permite a las aplicaciones conectarse y consultar datos y funcionalidades geográficas a través de la red usando el protocolo HTTP', True, 0, 3,  1, '01-08-2025', null),
(null, 'Servicios Rest', 'Son servicios desarrollados propiamente por la entidad', True, 0, 4, 1, '01-08-2025', null),
...
('servicios_rest_arcgis', 'Servicio REST:ArcGIS Mapserver', 'Es un conjunto de especificaciones de API que permiten a las aplicaciones comunicarse con los servicios de ubicación de ArcGIS a través de solicitudes HTTPS.', True, 3, 6,  1,'01-08-2025', 'map_search'),
...
('servicios_rest_arcgis_kml', 'Servicio REST:ArcGIS KML', 'Servicio Rest de exportación a formato KML', True, 3, 14,  1, '01-08-2025', 'file_json'),
('servicios_rest_arcgis_processing', 'Servicio REST:ArcGIS Geoprocessing', 'Servicio Rest de geoprocesamiento', False, 3, 15,  1, '01-08-2025', null),
('servicios_rest_api', 'Servicio REST:API', 'Servicios Rest:Api', True, 4, 16,  1, '01-08-2025', null);
