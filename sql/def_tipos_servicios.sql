...
('geoportales', null, 'Geoportales de entidades públicas', 'Portales públicos que comparten información geográfica y servicios especializados.', True, 1, 1,  1, '01-08-2025','captive_portal'),
('visores', null, 'Visores de mapas', 'Visores de mapas desarrollados por las instituciones públicas.', True, 1, 2,  1, '01-08-2025',  'jamboard_kiosk'),
('observatorios', null, 'Observatorios digitales', 'Un observatorio digital es una plataforma o sistema diseñado para recopilar, procesar, analizar y clasificar información de diversos entornos digitales con el fin de extraer conocimiento y apoyar la toma de decisiones', False, 1, 11,  1, '01-08-2025', 'mystery'),
('apps', null, 'Aplicaciones y módulos', 'Aplicaciones GIS y módulos geográficos.', True, 1, 3,  1, '01-08-2025', 'apps'),
('metadatos', null, 'Portal de metadatos', 's una aplicación en línea que permite a los usuarios buscar y acceder a información descriptiva (metadatos) sobre conjuntos de datos geográficos, como mapas, imágenes y capas de un Sistema de Información Geográfica (SIG).', True, 1, 16,  1, '01-08-2025', 'quick_reference_all'),
('descargas', null, 'Descarga GIS (HTTPS, FTP)', 'Es transferencia de archivos de Sistemas de Información Geográfica (GIS) a través de protocolos de red como FTP (Protocolo de Transferencia de Archivos) y HTTPS (Protocolo de Transferencia de Hipertexto Seguro). FTP se usa para la transferencia de archivos y la administración en un servidor, mientras que HTTPS se usa más para el acceso seguro y sencillo a través de un navegador web, encriptando los datos transmitidos.', True, 1, 17,  1, '01-08-2025', 'browser_updated'),
('servicios_ogc_wms', 'OGC:WMS', 'Servicio de visualiación de mapas', 'El servicio OGC:WMS permite visualizar mapas en un visor o un software de Sistema de Información Geográfica - GIS.', True, 2, 4,  1, '01-08-2025', 'travel_explore'),
