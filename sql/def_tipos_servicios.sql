...
('observatorios', null, 'Observatorios digitales', 'Un observatorio digital es una plataforma o sistema diseñado para recopilar, procesar, analizar y clasificar información de diversos entornos digitales con el fin de extraer conocimiento.', False, 1, 11,  1, '01-08-2025', 'mystery'),
('apps', null, 'Aplicaciones y módulos', 'Son los programas y herramientas de software que a través de módulos geográficos permiten crear, gestionar, analizar y visualizar datos georreferenciados en mapas.', True, 1, 3,  1, '01-08-2025', 'apps'),
('metadatos', null, 'Portal de metadatos', 'Es una aplicación en línea que permite a los usuarios buscar y acceder a información descriptiva (metadatos) sobre conjuntos de datos geográficos, como mapas, imágenes y capas de un Sistema de Información Geográfica (SIG).', True, 1, 16,  1, '01-08-2025', 'quick_reference_all'),
('descargas', null, 'Descarga GIS (HTTPS, FTP)', 'Es transferencia de archivos de Sistemas de Información Geográfica (GIS) a través de protocolos FTP y HTTPS.', True, 1, 17,  1, '01-08-2025', 'browser_updated'),
