...
-- ENTIDAD
--
INSERT INTO ide.def_instituciones (codigo,sigla, nombre, orden, id_padre, usuario_registro, fecha_registro) VALUES
...
-- SECTOR
--
INSERT INTO ide.def_instituciones (orden, codigo, nombre , id_padre, usuario_registro, fecha_registro) VALUES
...
--\copy ide.def_instituciones (codigo, nombre, id_padre, sigla, usuario_registro, fecha_registro) FROM 'C:\Apps\python\Flask\geoidep\sql\instituciones.csv' WITH (FORMAT csv, DELIMITER ';', QUOTE '"', HEADER true, ENCODING 'UTF8');

--\copy ide.def_instituciones (ubigeo, codigo, nombre, id_padre, usuario_registro, fecha_registro) FROM 'C:\Apps\python\Flask\geoidep\sql\municipalidades.csv' WITH (FORMAT csv, DELIMITER ';', QUOTE '"', HEADER true, ENCODING 'UTF8');
