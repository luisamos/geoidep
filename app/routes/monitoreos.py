...
from app.services.ogc import IDS_PADRE_SERVICIOS
from app.services import tarea_monitoreo
from app.routes.helpers import (
    obtener_usuario_actual,
    redirect_to_login,
    usuario_puede_ver_todas_entidades,
)
...
def datos_monitoreo_servicios(usuario):
  ...
  tipos_sg = Tipo.query.filter(
      Tipo.id_padre.in_(IDS_PADRE_SERVICIOS),
      Tipo.estado == True,
...
def herramientas():
  ...
  return render_template(
      ...
      usuario_actual=usuario,
      tarea_estado=tarea_monitoreo.tarea.to_dict(),
      **datos,
  )
